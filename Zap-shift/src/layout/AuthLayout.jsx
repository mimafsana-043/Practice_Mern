        ...
        <div className='min-h-screen overflow-hidden bg-[linear-gradient(135deg,#f7fbff_0%,#eef4ff_48%,#fff6ef_100%)] text-slate-900'>
            <div className='mx-auto flex min-h-screen max-w-7xl flex-col px-4 py-6 sm:px-6 lg:px-8'>
                ...
                <div className='grid flex-1 items-center gap-10 lg:grid-cols-2'>
                    ...
                    <div className='relative hidden overflow-hidden rounded-4xl border border-white/60 bg-white/55 shadow-[0_30px_80px_rgba(15,23,42,0.12)] backdrop-blur md:block'>
                        ...
                        <img className='relative h-full min-h-160 w-full object-cover object-center' src={authImage} alt="Auth" />
                    </div>
                </div>
            </div>
        </div>
